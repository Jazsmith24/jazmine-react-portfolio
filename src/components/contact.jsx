                ...
                <div id="contact" className="box-shadow-full">
                  <div className="row">
                    <div className="col-md-6">
                      ...
                      <div>
                        <form
                          action="https://formspree.io/f/myylznod"
                          method="POST"
                        ...
                        <p className="lead">
                          ...
                          Simply fill the form and send me an email.
                             ...
                             <ul className="list-ico">
                                ...
                                <li><span className="ion-ios-telephone"></span> (504) 577-8922</li>
                                <li><span className="ion-email"></span> jazminetsmith@gmail.com</li>
                              </ul>
                      </div>
